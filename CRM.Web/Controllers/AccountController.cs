    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(ExtendedIdentityModels model)
        {
            if (ModelState.IsValid)
            {
                ...
                var user = new ApplicationUser { FirstName = model.FirstName, LastName = model.LastName, UserStatusID = 1, UserName = model.UserName, Email = model.Email, BirthDate = model.BirthDate, ProfilePicture = data };
        ...
        public FileContentResult ProfilePhoto(string userId)
        {
